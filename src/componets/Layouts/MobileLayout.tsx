    ...
    <div className='min-h-full text-white px-4 pb-14 bg-gradient-to-b from-slate-900 from-10% to-slate-950 to-90%'>
      ...
      <nav className='bg-slate-800 text-white py-3 -mx-4 text-center w-full fixed bottom-0'>
        <ul className='flex justify-center gap-4'>
          <li>
            <NavLink className={({ isActive }) => classNames("inline-flex items-center py-2 px-4 rounded-lg hover:bg-slate-900", { "bg-slate-900": isActive})} to="/expenses">
              <Icon prefix="fas" name="dollar-sign" className='mr-3' />
              Gastos
            </NavLink>
          </li>
          <li>
            <NavLink className={({ isActive }) => classNames("inline-flex items-center py-2 px-4 rounded-lg hover:bg-slate-900", { "bg-slate-900": isActive})} to="/bakery">
